...
export default function ProductOwnerWelcomeOptions() {
	...
	const userStoriesSections: DropdownMenuSection[] = [
		{
			items: [
				...
				{ label: "Historias en backlog", href: "/user-stories?status=backlog" },
				{
					...
					href: "/user-stories?status=planned",
				},
				{
					label: "Historias en progreso",
					href: "/user-stories?status=in_progress",
				},
			],
		},
		{
	...
	const userStoryIcon = (
		<svg
			...
			aria-hidden="true"
		>
			<title>Icono de historia de usuario</title>
			<path
				strokeLinecap="round"
					...
					<div className="bg-amber-50 p-5 rounded-lg border border-amber-200">
						<div className="flex justify-between items-start mb-4">
							<div>
								...
								<p className="text-gray-600 mt-1">
									Administra el backlog y prioriza funcionalidades.
								</p>
							</div>
							<svg
								xmlns="http://www.w3.org/2000/svg"
						...
						<div className="flex justify-between items-center">
							<a href="/backlog" className="text-amber-600 hover:underline">
								Ver backlog →
							</a>
							<DropdownMenu
								buttonText="Opciones"
					...
					<div className="bg-blue-50 p-5 rounded-lg border border-blue-200">
						<div className="flex justify-between items-start mb-4">
							<div>
								...
								<p className="text-gray-600 mt-1">
									Visualiza el progreso y estado de tus proyectos.
								</p>
							</div>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								...
								aria-hidden="true"
							>
								<title>Icono de reportes de avance</title>
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
									strokeWidth="2"
