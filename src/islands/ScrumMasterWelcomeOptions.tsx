  ...
  const impedimentsSections: DropdownMenuSection[] = [
    {
      items: [
        ...
        {
          label: 'Impedimentos resueltos',
          href: '/impediments?filter=resolved',
        },
      ],
    },
    {
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 p-5 rounded-lg border border-green-200">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Programa y gestiona las reuniones del equipo.
                </p>
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex justify-between items-center">
              <a href="/meetings" className="text-green-600 hover:underline">
                Gestionar reuniones →
              </a>
              <DropdownMenu
                buttonText="Opciones"
                sections={meetingsSections}
                className="ml-2"
              />
            </div>
          </div>
          ...
          <div className="bg-amber-50 p-5 rounded-lg border border-amber-200">
            ...
            <div className="flex justify-between items-center">
              <a href="/impediments" className="text-amber-600 hover:underline">
                Ver impedimentos →
              </a>
              <DropdownMenu
                buttonText="Opciones"
